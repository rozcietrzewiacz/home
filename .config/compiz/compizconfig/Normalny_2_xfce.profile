...
as_mipmap = true
as_decoration_match = !title=CONKy
as_shadow_match = !title=CONKy

[winrules]
s0_skiptaskbar_match = title=CONKy
...
s0_no_minimize_match = title=CONKy
...
[core]
as_active_plugins = regex;expo;ccp;decoration;winrules;png;shift;imgjpeg;resize;move;minimize;splash;ring;place;svg;widget;bench;wall;wobbly;fade;scale;scalefilter
as_texture_filter = 0
