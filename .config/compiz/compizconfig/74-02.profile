...
[core]
as_active_plugins = workarounds;regex;decoration;winrules;wobbly;png;shift;imgjpeg;expo;dbus;resize;move;core;minimize;splash;ring;place;plane;svg;widget;bench;extrawm;fade;group;scale;
as_texture_filter = 0
...
as_plane_to_1_key = <Control><Alt>1
as_plane_to_2_key = <Control><Alt>2
as_plane_to_3_key = <Control><Alt>3
as_plane_to_4_key = <Control><Alt>4
as_plane_to_5_key = <Control><Alt>5
as_plane_to_6_key = <Control><Alt>6
...
as_arrow_base_color = #7b0000b4
as_arrow_shadow_color = #500909d9
