...
globals = {
 ...
 -- http_proxy          = "http://example.com:3128",
    default_window_size = "800x600", -- XXX can be used for "luakit" webkiosk Xsession
...
search_engines = {
    ...
    goo         = "http://google.com/search?q=%s",
    ddg         = "http://duckduckgo.com/?q=%s",
    wikipedia   = "http://en.wikipedia.org/wiki/Special:Search?search=%s",
    wik         = "http://en.wikipedia.org/wiki/Special:Search?search=%s",
    wpl         = "http://pl.wikipedia.org/wiki/Special:Search?search=%s",
    debbugs     = "http://bugs.debian.org/%s",
    imdb        = "http://imdb.com/find?s=all&q=%s",
    sourceforge = "http://sf.net/search/?words=%s",
    qt        = "javascript:void(location.href='http://quietube.com/v.php/'+location.href)",
}
