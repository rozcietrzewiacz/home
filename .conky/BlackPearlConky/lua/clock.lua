...
bg_alpha_g = 0.1
fg_alpha_g = 0.6
bg_colour_g = 0xffffff
fg_colour_g = 0xd7d7d7
...
function draw_ring(cr,t,pt)
  ...
  local bgc, bga, fgc, fga
        =
         ( pt.bg_colour or bg_colour_g ), 
         ( pt.bg_alpha  or bg_alpha_g  ),
         ( pt.fg_colour or fg_colour_g ),
         ( pt.fg_alpha  or fg_alpha_g  )
